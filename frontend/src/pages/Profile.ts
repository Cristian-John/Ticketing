                    ...
                    <form id="change-password-form" class="change-password-form">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" id="profile-current-password" class="form-control" style="padding-left:1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" id="profile-new-password" class="form-control" style="padding-left:1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" id="profile-confirm-password" class="form-control" style="padding-left:1rem;">
