import { Ticket, Article, Stats, Note, Attachment, UserSession } from '../types';
...
export const usersAPI = {
    ...
    resetPassword: (id: string, passwordPlain: string): Promise<{ success: boolean }> =>
        api<{ success: boolean }>(`/users/${id}/reset-password`, { method: 'PUT', body: JSON.stringify({ password: passwordPlain }) }),
    changePassword: (currentPassword: string, newPassword: string, confirmPassword: string): Promise<{ success: boolean; message: string }> =>
        api<{ success: boolean; message: string }>('/users/me/change-password', { method: 'PUT', body: JSON.stringify({ currentPassword, newPassword, confirmPassword }) }),
};
...
export const authAPI = {
    ...
    register: (fullName: string, username: string, email: string, password?: string): Promise<{ success: boolean; user: UserSession }> =>
