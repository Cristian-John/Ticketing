export class NotificationEmptyState {
        ...
        return `
            ...
            <div class="empty-list-wrapper">
                <div class="glow-icon-container">
                    ...
                    <i data-lucide="check-circle-2" style="width: 56px; height: 56px; color: var(--accent);"></i>
                </div>
                <h3 class="title-lg" style="color: var(--text-primary); font-weight: 700; font-size: 1.25rem;">You're all caught up!</h3>
                ...
                <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--border-color); width: 100%; max-width: 240px;">
                    <p class="body-sm" style="color: var(--text-secondary); margin-bottom: 8px;">Why not check your pending <strong>Transfers</strong>?</p>
                    <a href="#" onclick="event.preventDefault(); document.querySelector('[data-filter=\\'transfers\\']')?.click();" style="color: var(--primary); font-weight: 600; font-size: 0.85rem; text-decoration: none; letter-spacing: 0.05em; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">[View Pending]</a>
                </div>
            </div>
        `;
    }
            ...
            <div style="padding: var(--space-xl); height: 100%; box-sizing: border-box;">
                <div class="detail-empty-polished">
                    <div style="position: relative; z-index: 1;">
                        <i data-lucide="mouse-pointer-click" style="width: 56px; height: 56px; color: var(--text-secondary); margin-bottom: 20px; opacity: 0.7;"></i>
                    </div>
                    <h3 class="title-lg" style="position: relative; z-index: 1; color: var(--text-primary); font-weight: 700; margin-bottom: 8px;">Select a notification</h3>
    ...
    public static renderLoadingDetail(): string {
        return `
            <div class="detail-empty">
                <div class="empty-state-icon"><i data-lucide="loader-2" class="animate-spin" style="width: 48px; height: 48px; color: var(--text-muted); margin-bottom: var(--space-md);"></i></div>
    ...
    public static renderNotFoundDetail(): string {
        return `
            <div class="detail-empty">
                <div class="empty-state-icon"><i data-lucide="alert-circle" style="width: 48px; height: 48px; color: var(--text-muted); margin-bottom: var(--space-md);"></i></div>
